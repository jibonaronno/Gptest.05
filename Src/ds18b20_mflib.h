...
#define TXRX_PORT	GPIOC					// <-- select the 1-wire signal line port (GPIOA or GPIOB or ...)
#define TXRX_PIN	GPIO_PIN_3		// <-- select the 1-wire signal line pin (GPIO_PIN_1 or GPIO_PIN_2 or ...)
